  ...
  <div class="container">
    <aside>
      ...
      <ul class="categories">
        ...
        <li><span><a href="AddHOD.jsp">Add HoD</a></span></li>
    ...
    <section id="content">
      ...
      <div class="inside">
               ...
               <div class="img-box" style="text-align:justify;">
                   ...
                   <table>
                       <tr>
                           <th>Name</th> <th>Email</th><th>Mobile</th> <th>Emp ID</th> <th>Branch</th> <th>Status</th>
                       </tr>
                       <%
                       try{
                          ResultSet r=Queries.getExecuteQuery("select * from fregister");
                          while(r.next()){
                               ...
                               <td><%=r.getString("name")%></td>
                                <td><%=r.getString("email")%></td>
                                 <td><%=r.getString("mobile")%></td>
                                  <td><%=r.getString("empid")%></td>
                                   <td><%=r.getString("branch")%></td>
                                  <%
                                  if(status.equals("waiting")){
                                   %>
                                   <td><a href="Activate_Faculty.jsp?id=<%=r.getString("id")%>">Activate</a></td>
                                   <%
                                  }else{
 %>
