    ...
    <div class="container">
      ...
      <nav>
        <ul>
          ...
          <li class="current"><a href="HOD.jsp" class="m4">HOD</a></li>
    ...
    <section id="content">
      ...
      <div class="inside">
        ...
        <div class="img-box" style="text-align:justify;"><img src="images/1924893194_2019-06-29_12-37-00.png" width="250">
            ...
            <h2>HOD Login Here</h2>
            <form action="H_LoginAtion.jsp" method="post">
                 <table>
                     <tR><th>HOD ID: </th><td><input type="text" name="empid" required=""></td></tr>
                     <tR><th>Password: </th><td><input type="password" name="pwd" required=""></td></tr>
                    
                     <tR><th> </th><td><input type="submit" value="Login" required=""> <a href="HODRegister.jsp">Register</a></td></tr></tr>
                 </table>
             </form>
