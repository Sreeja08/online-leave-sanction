    ...
    <div class="container">
      ...
      <nav>
        <ul>
          ...
          <li  class="current"><a href="Student.jsp" class="m2">Student</a></li>
  ...
  <div class="container">
    ...
    <section id="content">
      ...
      <div class="inside">
        ...
        <div class="img-box" style="text-align:justify;"><img src="images/stu_login.gif">
            
            <h2>Student Login Here</h2>
            <form action="LoginAction.jsp" method="post">
                 <table>
                     <tR><th>Roll No: </th><td><input type="text" name="rollno" required=""></td></tr>
                     <tR><th>Password: </th><td><input type="password" name="pwd" required=""></td></tr>
                     <tR><th> </th><td><input type="submit" value="Login" required=""> <a href="Register.jsp">Register</a></td></tr>
                 </table>
             </form>
