  ...
  <div class="container">
    ...
    <section id="content">
      ...
      <div class="inside">
        ...
        <div class="img-box" style="text-align:justify;"><img src="images/admin-login-icon-15.png">
            ...
            <form action="AdminAction.jsp" method="post">
                 <table>
                     ...
                     <tR><th> </th><td><input type="submit" value="Login" required=""> 
                         <input type="reset" value="Reset" required=""> </td></tr>
                 </table>
             </form>
