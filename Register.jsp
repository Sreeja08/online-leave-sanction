...
<div class="wrap">
  ...
  <div class="container">
    <aside>
      ...
      <img src="images/213654-540ceebd-e2b9-4657-8f82-79ae2bf24b1f.png" width=250" height="400">
            ...
            <h2>Register Here</h2>
             <form action="RegAction.jsp" method="post">
                 <table>
                     <tR><th>Name: </th><td><input type="text" name="name" required=""></td>
                      <th>Email </th><td><input type="email" name="email" required=""></td></tr>
                       <tR><th>Mobile: </th><td><input type="number" name="mobile" required=""></td></tr>
                         <tR><th>RollNo: </th><td><input type="text" name="rollno" required=""></td>
                     ...
                     <tR><th>Guardian</th><td><input type="text" name="Guardian" required=""></td></tr>
                     <tR><th>Guardian Email</th><td><input type="email" name="gemail" required=""></td>
                      <th>Guardian Mobile</th><td><input type="text" name="gmobile" required=""></td></tr>
                     
                     <tR><th>Password: </th><td><input type="password" name="pwd" required=""></td>
                   <th> </th><td><input type="submit" value="Register" required=""> <a href="Student.jsp">LOGIN</a></td></tr>
                 </table>
             </form>
